...
project, I configured Nginx on the web servers provided me by the school
to serve a Flask app running through Gunicorn.

## Tasks :page_with_curl:

* **0. Set up development with Python**
  * In this task, I configured the file `web_flask/0-hello_route.py` from my
  [AirBnB_clone_v2](https://github.com/CorneliusNgure/AirBnB_clone_v2) to serve content
